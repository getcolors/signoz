...
resource "digitalocean_ssh_key" "machine" {
  ...
  public_key = trimspace(file("/home/build-placeholder/.ssh/signoz-digitalocean-fixture.pub"))
}
...
resource "digitalocean_droplet" "signoz" {
  ...
  connection {
    ...
    private_key = file("/home/build-placeholder/.ssh/signoz-digitalocean-fixture")
  }
...
resource "digitalocean_firewall" "signoz" {
  name        = "signoz-digitalocean-fixture-firewall"
