...
[[ -f "$tmp/.colors/signoz-fixture/compute/shared/backend.tf.json" ]]
...
grep -q "colors-compute.git\", rev = \"$compute_sha\"" "$root/skills/package-signoz-blue/blue"
...
# missing peer.
red_launcher="$root/skills/package-signoz-red/red"
...
[[ -f "$tmp/red-cold/.colors/signoz-fixture/compute/shared/backend.tf.json" ]]
